...
/* =====================================================
   PPW OPENING LOADER CONTROLLER
   The animation has its own fixed timeline so it is not
   held open by a slow image or third-party resource.
===================================================== */
(function(){
    ...
    function hideLoader(){
        ...
        const remaining = Math.max(0, finishAt - (performance.now() - started));
    ...
    // Start immediately. Do not wait for window.load; the page can continue
    // loading article images and other resources behind the opening screen.
