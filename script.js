...
/* =====================================================
   PPW FULL-SCREEN OPENING OVERLAY CONTROLLER
===================================================== */
(function(){
    const loader = document.getElementById("ppwLoader");
    if(!loader) return;

    document.documentElement.classList.add("ppw-loader-active");
    document.body.classList.add("ppw-loading");

    // The overlay has a deliberate, fixed timeline. It does not wait for
    // images, Supabase, fonts, or other network resources.
